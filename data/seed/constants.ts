...
// predicate through a plain non-personalized/naive template instead of
// calling the AI model, so Rule 9 has real, deterministic content to catch in
// the batch run regardless of the AI model's (compliant-by-instruction) output.
