...
// every classifier (rule-based and Claude fallback alike).
 ...
 * Claude fallback (Phase 5.2 of BUILD_MANUAL.md). */
export const CONFIDENCE_ESCALATION_THRESHOLD = 0.5;

export type ClassificationSource = "rule_based" | "claude_fallback" | "claude_fallback_failed";
...
export type ClassificationResult<T extends string = RootCause> = {
  ...
  /** Set when the Claude fallback was needed but itself failed (Phase 6.2's
